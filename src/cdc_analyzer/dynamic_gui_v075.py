...
class DynamicPagesController(_V074DynamicPagesController):
    ...
    RESPONSE_HEADERS_ZH = {
        ...
        "Total Transient Time ms": "总瞬态时间 / ms",
        "Force Settling Time ms": "力稳定时间 / ms",
        ...
        "Current Extreme A": "电流极值 / A",
        "Current Extreme Time s": "电流极值时间 / s",
        "Current Time to Extreme ms": "电流到极值时间 / ms",
        "Current Recovery Time ms": "电流恢复时间 / ms",
