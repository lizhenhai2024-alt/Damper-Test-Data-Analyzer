...
from .gui_release_v092 import _build_release_gui_classes_v092
from .product_info import COMPANY_EN, PRODUCT_NAME


def _build_release_gui_classes_v093():
    _QtCore, QtWidgets, _pg = _qt_imports()
    BaseMainWindow = _build_release_gui_classes_v092()
...
def main() -> int:
    _QtCore, QtWidgets, _pg = _qt_imports()
    MainWindow = _build_release_gui_classes_v093()
